import {getBB} from './indicators.js';
...
wss.on("connection", (ws) => {
  ...
  binance.websockets.candlesticks(["BNBBTC"], "1m", (candlesticks) => {
    ...
    let {o: open,h: high, l: low, c: close, v: volume, n: trades, i: interval,x: isFinal, q: quoteVolume,V: buyVolume,Q: quoteBuyVolume,
    } = ticks;
